...
public class AppTest {
    ...
    public void test_Check_Method_Exist() {
        try {
            ...
            OrderServiceImpl.class.getDeclaredMethod("getAllOrder");
    ...
    public void test_Create_Query_Exist() throws Exception {
        Order order = new Order(1, "John", "2025-05-19", 99.99, "Pending");
    ...
    public void test_Delete_Query_Exist() throws Exception {
        // First, add an order
        Order order = new Order(2, "Test Delete", "2025-05-20", 49.99, "Pending");
